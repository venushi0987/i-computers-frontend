...
export default function CartPage() {
    ...
    return (
        <div className="w-full min-h-[calc(100vh-100px)] overflow-y-scroll flex flex-col items-center py-4 ">
            {
                cart.map(
                    (item, index) => {
                        return (
                            <div key={index} className="w-[550px] h-[130px] bg-white my-2 rounded-md shadow-md flex flex-row overflow-hidden">
